...
c ____________________________________________
    ...
    7     3      -2.7  -16 91 -92 8                  imp:p=1  $ Upper Brass Clasp
    8     3      -2.7  -93 94 -92 8                  imp:p=1  $ Lower Brass Clasp
...
c Al Clasps:
   ...
   93        pz 8.030000015  $ Top of Lower clasp(0.86cm below upper)
   94        pz 7.169999985  $ Bottom of lower clasp
...
c **** Source Encapsulation: POSITION 4: 6cm down side of Al Casing, adjusted cell
    ...
    28        px 5.03        $ Top of Mylar Under Source, 0.2mm thick
    29        c/x 0 7.6 1.27         $ Mylar Cyinder, 1 mm wide
...
sdef erg=d3 par=2 x=5.027 y=0 z=7.6
