...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Automated Parametric Optimization of a High-Purity Germanium Monte Carlo Neutral-Particle Model }
\author{Bryan V.~Egner,$^{*}$ and Robert S.~Torzilli,$^{\dagger}$}
...
Note how Fig.ses dashed lines verb|--| for the exact
